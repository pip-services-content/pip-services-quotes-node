...
class QuotesController {
    constructor() {
        this._dependencyResolver = new pip_services3_commons_node_2.DependencyResolver(QuotesController._defaultConfig);
    }
    configure(config) {
    ...
    createQuote(correlationId, quote, callback) {
        ...
        quote.all_tags = pip_services3_commons_node_3.TagsProcessor.extractHashTags("#text#author");
