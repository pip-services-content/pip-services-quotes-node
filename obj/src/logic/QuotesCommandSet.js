...
class QuotesCommandSet extends pip_services3_commons_node_1.CommandSet {
    constructor(logic) {
        super();
        this._logic = logic;
    ...
    makeGetQuotesCommand() {
        return new pip_services3_commons_node_2.Command("get_quotes", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeGetRandomQuoteCommand() {
        return new pip_services3_commons_node_2.Command("get_random_quote", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeGetQuoteByIdCommand() {
        return new pip_services3_commons_node_2.Command("get_quote_by_id", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('quote_id', pip_services3_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
            let quote_id = args.getAsString("quote_id");
            this._logic.getQuoteById(correlationId, quote_id, callback);
        });
    }
    makeCreateQuoteCommand() {
        return new pip_services3_commons_node_2.Command("create_quote", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeUpdateQuoteCommand() {
        return new pip_services3_commons_node_2.Command("update_quote", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('quote', new QuoteV1Schema_1.QuoteV1Schema()), (correlationId, args, callback) => {
            let quote = args.get("quote");
    ...
    makeDeleteQuoteByIdCommand() {
        return new pip_services3_commons_node_2.Command("delete_quote_by_id", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('quote_id', pip_services3_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
