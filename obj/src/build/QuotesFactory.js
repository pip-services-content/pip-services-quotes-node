...
class QuotesFactory extends pip_services_commons_node_1.Factory {
    constructor() {
        ...
        this.registerAsType(QuotesFactory.HttpServiceDescriptor, QuotesHttpServiceV1_1.QuotesHttpServiceV1);
    }
}
...
QuotesFactory.HttpServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-quotes", "service", "http", "*", "1.0");
