...
class QuotesServiceFactory extends pip_services_commons_node_1.Factory {
    constructor() {
        super();
...
QuotesServiceFactory.Descriptor = new pip_services_commons_node_2.Descriptor("pip-services-quotes", "factory", "default", "default", "1.0");
QuotesServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-quotes", "persistence", "memory", "*", "1.0");
QuotesServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-quotes", "persistence", "file", "*", "1.0");
QuotesServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-quotes", "persistence", "mongodb", "*", "1.0");
QuotesServiceFactory.ControllerDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-quotes", "controller", "default", "*", "1.0");
QuotesServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-quotes", "service", "seneca", "*", "1.0");
QuotesServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-quotes", "service", "http", "*", "1.0");
