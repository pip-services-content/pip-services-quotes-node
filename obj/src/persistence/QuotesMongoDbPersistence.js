...
const QuotesMongooseSchema_1 = require("./QuotesMongooseSchema");
class QuotesMongoDbPersistence extends pip_services3_mongoose_node_1.IdentifiableMongoosePersistence {
    constructor() {
        super('quotes', QuotesMongooseSchema_1.QuotesMongooseSchema());
    }
