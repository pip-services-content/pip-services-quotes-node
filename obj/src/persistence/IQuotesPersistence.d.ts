...
export interface IQuotesPersistence extends IGetter<QuoteV1, string>, IWriter<QuoteV1, string> {
    ...
    getOneById(correlationId: string, id: string, callback: (err: any, item: QuoteV1) => void): void;
    create(correlationId: string, item: QuoteV1, callback: (err: any, item: QuoteV1) => void): void;
    update(correlationId: string, item: QuoteV1, callback: (err: any, item: QuoteV1) => void): void;
    deleteById(correlationId: string, id: string, callback: (err: any, item: QuoteV1) => void): void;
}
